...
let fake = process.env.OWNER_NUMBER === undefined ? '923461253726' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'true' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'DevBaloCH' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? '03461253726' : process.env.STICKER_AUTHOR_NAME
